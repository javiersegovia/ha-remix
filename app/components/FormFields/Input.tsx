...
export const inputBaseStyles =
  'placeholder:text-gray-400 block p-3 w-full text-sm leading-6 bg-white border shadow-sm rounded-[15px] border-gray-300 focus:outline-none focus:ring-1 focus:border-gray-400 focus:ring-gray-400'
