...
export const inputBaseStyles =
  'placeholder:text-gray-400 block p-3 w-full text-sm leading-6 bg-white border shadow-sm rounded-[15px] border-gray-300 focus:outline-none focus:ring-2 focus:border-blue-400 focus:ring-blue-400'
