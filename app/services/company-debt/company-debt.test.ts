...
describe('getCompanyDebtById', () => {
  test('should return a CompanyDebt', async () => {
    const date = new Date()
...
describe('getCompanyDebtsByCompanyId', () => {
  test('should return an array of CompanyDebts', async () => {
    const date = new Date()
...
describe('upsertFiatMonthlyDebt', () => {
  test('when there is no existing CompanyDebt', () => {
    test('should create a new CompanyDebt', async () => {
      const date = new Date()
      const expectedResult = {
        companyId: '123',
        createdAt: date,
      ...
      vi.spyOn(prisma.companyDebt, 'create').mockResolvedValueOnce(
        expectedResult
      )
  ...
  test('when there is an existing CompanyDebt', () => {
    test('should update the existing CompanyDebt with a new value', async () => {
      const date = new Date()
      const expectedResult = {
        id: 'companyDebtId123',
        companyId: '123',
      ...
      vi.spyOn(prisma.companyDebt, 'update').mockResolvedValueOnce(
        expectedResult
      )
