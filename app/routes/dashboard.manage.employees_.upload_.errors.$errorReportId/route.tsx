...
const DashboardManageUploadErrorDetailsRoute = () => {
  const { errorReportId, details } = useLoaderData<typeof loader>()

  if (!details) {
    return (
      <Container>
        <GoBack redirectTo={$path('/dashboard/manage/employees/upload')} />
...
export default DashboardManageUploadErrorDetailsRoute
